...
public class RecordOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Book> b = c.getListBook();
        
        c.addOrder(b, date, cId);
        ...
        s.setAttribute("username",cId);
        s.setAttribute("quantity", c.getCount());
        response.sendRedirect("Page/ConfirmCheckout.jsp");
