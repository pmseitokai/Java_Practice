...
public class Edit extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        c.setMobile(request.getParameter("tel"));
        c.setEmail(request.getParameter("email"));
        
        c.editProfile(s.getAttribute("username").toString());
        
        s.setAttribute("name",request.getParameter("name"));
        s.setAttribute("surname",request.getParameter("surname"));
        s.setAttribute("address",request.getParameter("address"));
        s.setAttribute("province",request.getParameter("province"));
        s.setAttribute("zip",request.getParameter("zip"));
        s.setAttribute("tel",request.getParameter("tel"));
        s.setAttribute("email",request.getParameter("email"));
        
        response.sendRedirect("Page/customer_profile.jsp");
